...
async def search_series_for_episode(m: types.Message, state: FSMContext):
    ...
    await m.answer("👇 নিচে থেকে আপনার কাঙ্্থিত সিরিজটি সিলেক্ট করুন:", reply_markup=builder.as_markup())
            ...
            function startAdCarouselsAutoScroll() {
                ...
                adScrollInterval = setInterval(() => {
                    ...
                    tracks.forEach(track => {
                        if (!track) return;
                        const cardWidth = 262; // প্রতি কার্ডের প্রস্থ (২৫০px প্রস্থ + ১২px গ্যাপ)
                ...
                }, 4000); // প্রতি ৪ সেকেন্ড পর পর ব্যানার স্ক্রোল হবে
            }
